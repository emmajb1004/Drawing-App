function MirrorDrawTool() {
	...
	this.populateOptions = function() {
		select(".options").html(
			"<button id='directionButton'>Make Horizontal</button> </br> Mirror Draw: Draw symmetrically. Change between horizontal point of symmetry or vertical point using button");
		// 	//click handler
